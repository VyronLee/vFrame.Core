...
using System;
using System.IO;
using vFrame.Core.ThirdParty.SevenZip.Compression.LZ;
using vFrame.Core.ThirdParty.SevenZip.Compression.RangeCoder;

namespace vFrame.Core.ThirdParty.SevenZip.Compression.LZMA
{
