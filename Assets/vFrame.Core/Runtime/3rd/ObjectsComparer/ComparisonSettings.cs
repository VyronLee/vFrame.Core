...
namespace vFrame.Core
{
    ...
    {
        private readonly Dictionary<Tuple<Type, string>, object> _settings =
        ...
        ///     do not implement <see cref="IComparable" /> will be compared as separate objects using the same rules as current
        ///     objects. True by default.
        /// </summary>
        public bool RecursiveComparison { get; set; }

        /// <summary>
        ///     If true, empty <see cref="System.Collections.IEnumerable" />  and null values will be considered as equal values.
        ///     False by default.
        /// </summary>
        public bool EmptyAndNullEnumerablesEqual { get; set; }

        /// <summary>
        ///     If true and member does not exists, objects comparer will consider that this member is equal to default value of
        ///     opposite member type.
