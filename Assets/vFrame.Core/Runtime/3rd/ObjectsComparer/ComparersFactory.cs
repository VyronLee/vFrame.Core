...
namespace vFrame.Core
{
    ...
    public class ComparersFactory : IComparersFactory
    {
        ...
        public virtual IComparer<T> GetObjectsComparer<T>(ComparisonSettings settings = null,
        ...
        public IComparer GetObjectsComparer(Type type, ComparisonSettings settings = null,
            BaseComparer parentComparer = null) {
