...
{
    /// <summary>
    ///     Implementation of <see cref="IValueComparer{T}" /> which provides simplest implementation of
    ///     <see cref="ToString(T)" /> method and
    ///     <see cref="Compare(object, object, ComparisonSettings)" /> method to call
    ///     <see cref="Compare(T, T, ComparisonSettings)" />.
    /// </summary>
