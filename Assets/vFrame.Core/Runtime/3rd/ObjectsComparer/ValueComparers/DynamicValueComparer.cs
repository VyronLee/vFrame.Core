...
namespace vFrame.Core
{
    ...
    public class DynamicValueComparer<T> : IValueComparer
    {
        ...
        public DynamicValueComparer(Func<T, T, ComparisonSettings, bool> compareFunction) : this(compareFunction,
        ...
        public DynamicValueComparer(Func<T, T, ComparisonSettings, bool> compareFunction,
