...
namespace vFrame.Core
{
    ...
    {
        protected AbstractDynamicObjectsComprer(ComparisonSettings settings, BaseComparer parentComparer,
            IComparersFactory factory) : base(settings, parentComparer, factory) { }
        ...
        public override IEnumerable<Difference> CalculateDifferences(Type type, object obj1, object obj2) {
            ...
            foreach (var propertyKey in propertyKeys) {
                ...
                if (value1 != null && value2 != null && value1.GetType() != value2.GetType()) {
                    ...
                    yield return new Difference(propertyKey, valueComparer.ToString(value1),
                        valueComparer2.ToString(value2),
                ...
                if ((value1 == null && value2 != null && value2.GetType().GetTypeInfo().IsValueType) ||
                    ...
                    var valueComparer2 = value2 != null
                        ? OverridesCollection.GetComparer(value2.GetType()) ??
                          OverridesCollection.GetComparer(propertyKey) ?? DefaultValueComparer
                        : DefaultValueComparer;
                    yield return new Difference(propertyKey, valueComparer.ToString(value1),
                        valueComparer2.ToString(value2),
                        DifferenceTypes.TypeMismatch);
                ...
                if (customComparer != null) {
                    if (!customComparer.Compare(value1, value2, Settings)) {
                        yield return new Difference(propertyKey, customComparer.ToString(value1),
                            customComparer.ToString(value2));
                    }
