...
namespace vFrame.Core
{
    internal class MultidimensionalArrayComparer<T> : AbstractComparer
    {
        ...
        public MultidimensionalArrayComparer(ComparisonSettings settings, BaseComparer parentComparer,
        ...
        public override IEnumerable<Difference> CalculateDifferences(Type type, object obj1, object obj2) {
            ...
            for (var i = 0; i < array1.Length; i++) {
                ...
                foreach (var failure in _comparer.CalculateDifferences((T)array1.GetValue(indecies),
                             (T)array2.GetValue(indecies))) {
