...
namespace vFrame.Core
{
    ...
    {
        public ExpandoObjectComparer(ComparisonSettings settings, BaseComparer parentComparer,
        ...
        public override bool IsMatch(Type type, object obj1, object obj2) {
            return type.InheritsFrom(typeof(ExpandoObject)) ||
                   (obj1 != null && obj2 != null && type == typeof(object) &&
                    obj1.GetType().InheritsFrom(typeof(ExpandoObject)) &&
                    obj2.GetType().InheritsFrom(typeof(ExpandoObject)));
        }
