...
namespace vFrame.Core
{
    internal static class TypeExtensions
    {
        public static bool InheritsFrom(this Type t1, Type t2) {
            ...
            if (t1.GetTypeInfo().GetInterfaces().Any(i =>
                    (i.GetTypeInfo().IsGenericType && i.GetGenericTypeDefinition() == t2) || i == t2)) {
                return true;
            }

            return t1.GetTypeInfo().BaseType != null && t1.GetTypeInfo().BaseType.InheritsFrom(t2);
        }
