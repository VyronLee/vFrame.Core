...
namespace vFrame.Core.Extensions.UnityEngine.UI
{
    public static class RectTransformExtension
    {
        ...
        public static bool OverlapsInWorldSpace(this RectTransform rc1, RectTransform rc2)
        {
            ...
            var r1 = new Rect(_corners_1[0].x, _corners_1[0].y, _corners_1[2].x - _corners_1[0].x, _corners_1[2].y - _corners_1[0].y);
            var r2 = new Rect(_corners_2[0].x, _corners_2[0].y, _corners_2[2].x - _corners_2[0].x, _corners_2[2].y - _corners_2[0].y);
